...
dd$label <- suppressWarnings(canton_namesStrict(as.character(dd$canton), "eng"))
...
hc <- hchart(dd, "heatmap", 
  ...
  hc_legend(layout = "horizontal", verticalAlign = "top",
            align = "center", valueDecimals = 0, x = -10) %>%
  hc_yAxis(plotLines = list(ch.line, de.line, fr.line)) %>%
   ...
   hc_xAxis(lineWidth = 0, title = list(text = ""), opposite = T) %>% 
  hc_size(height = 560)
